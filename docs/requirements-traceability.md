...
| R5 | AI-agent-native usage workflow | `.skills/playwright-electron-cli/SKILL.md` and concise command outputs | Phase 6 (AI Skill Integration) | Validate onboarding flow with an AI agent following SKILL instructions |
